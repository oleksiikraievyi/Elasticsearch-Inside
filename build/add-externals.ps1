...
function DownloadElasticsearch {
    ...
    $downloadUrl = "https://download.elastic.co/elasticsearch/elasticsearch/elasticsearch-2.3.4.zip" # New-Object System.Uri -ArgumentList @($url.Attributes["href"].Value)
